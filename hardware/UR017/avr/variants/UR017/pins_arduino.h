/*
 Ruiz Tech pin arduino to atmega256rfr2
*/
...
const uint8_t PROGMEM digital_pin_to_bit_mask_PGM[] = {
  ...
  _BV(PE3)  , // PE 3 ** D13 ** LED~
  _BV(PE4)  , // PE 4 ** D14 ** LED~*
  _BV(PE5)  , // PE 5 ** D15 ** LED~*
...
const uint8_t PROGMEM digital_pin_to_timer_PGM[] = {
  ...
  TIMER3A       , // PE 3 ** D13 ** LED~
  TIMER3B       , // PE 4 ** D14 ** LED~*
  TIMER3C       , // PE 5 ** D15 ** LED~*
