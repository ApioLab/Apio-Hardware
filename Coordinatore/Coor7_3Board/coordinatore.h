...
static void appDataConf(NWK_DataReq_t *req)
{
  ...
  switch(req->status)
  {
    ...
    case NWK_PHY_NO_ACK_STATUS:
      ...
      break;
//    default:
//      Serial11.print("no correspondence in ack");
//      break;
...
void LwmOutput()
{
      //Serial11.println("LwmOutput");//debug
      ...
      while(j<numberkey)
      {
        ...
        while(nwkDataReqBusy)
        {
          ...
          //Serial11.print(nwkDataReqBusy);        //debug
        }
        
        // Serial11.println(temp1);  //debug
...
{ 
  ...
  Serial1.println(String(bufferL)); 
  return true;
}
...
//  {
//      Serial11.println("Got a tesponse!");
//
//    // got a response!
//
...
//    {
//      Serial11.println("ZB_TX_STATUS_RESPONSE");
//
...
//        {
//          Serial11.println("PAYLOAD_TOO_LARGE");
//        }
//        // the remote XBee did not receive our packet. is it powered on?
//        //flashLed(errorLed, 3, 500);
//         Serial11.println("ERROR");
//
//        return false;
//
//      }
...
//       {
//         Serial11.print("Error reading packet.  Error code: ");  
//         Serial11.println(xbee.getResponse().getErrorCode());
//         return false;
//       } 
//       else 
//       {
//          Serial11.print("local XBee did not provide a timely TX Status Response");  
//
...
void XBeeOutput()
{
     //Serial11.println("XbeeOutput");//debug
      ...
      //the first property value to be send (j=0)
      temp2=propertyArray[j]+":"+valueArray[j]+"-";
      //Serial11.print("numberkey: ");//debug
      //Serial11.println(numberkey);//debug
...
void ApioCoordinatorSetup()
{
  ...
  //-------fine appunti---------//
  SYS_Init(); //in questa funzione (di libreria LW_Mesh, file sys.c) è stata eliminata sys_Uninit_Arduino() altrimenti non funzionava bene la Serial1e
